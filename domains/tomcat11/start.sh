...
export CATALINA_OPTS=" $JAVA_OPTS -Djboss.mod_cluster.jvmRoute=tomcat11 "
...
#export JAVA_OPTS="$JAVA_OPTS -Dpinpoint.agentId=tomcat11 -Dpinpoint.applicationName=Tomcat11 "
export JAVA_OPTS="$JAVA_OPTS -Dorg.apache.catalina.JSESSIONID=XSESSIONID"
#export JAVA_OPTS="$JAVA_OPTS -javaagent:/etc/apm-agent/elastic-apm-agent-1.12.0.jar"
#export JAVA_OPTS="$JAVA_OPTS -Delastic.apm.service_name=tomcat11"
